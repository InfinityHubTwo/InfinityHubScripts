...
Notification:Notify(
    {Title = "Misc", Description = "Keybind: J"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 6, Type = "image"},
    {Image = "http://www.roblox.com/asset/?id=13780014144", ImageColor = Color3.fromRGB(255, 255, 255)}
) wait(1)
Notification:Notify(
    {Title = "Modded Version", Description = "This Script is modded by InfinityMercury"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 6, Type = "image"},
    {Image = "http://www.roblox.com/asset/?id=13780014144", ImageColor = Color3.fromRGB(255, 255, 255)}
) wait(2)
...
local LeftBox = Tabs.Misc:AddLeftGroupbox('Misc')
local RightBox = Tabs.Misc:AddRightGroupbox('Soon')

local LeftEventGroupBox = Tabs.Events:AddLeftGroupbox('has no event')
