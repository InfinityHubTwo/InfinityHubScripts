...
local Release = "Infinity Hub v1.0"
...
pcall(function()
_G.LastRayField.Name = 'Old Infinity Hub'
...
function Hide()
	...
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping LeftControl", Duration = 7})
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Infinity Hub v1.0"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Darkzin"
	if Settings.LoadingTitle ~= "Infinity Hub v1.0" then
		LoadingFrame.Version.Text = "Infinity Hub v1.0"
	end
