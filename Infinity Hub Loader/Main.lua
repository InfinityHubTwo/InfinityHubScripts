...
local games = {
	...
	-- Shindo Life
	[{ShindoId}] = "https://raw.githubusercontent.com/InfinityHubTwo/InfinityHubScripts/main/Obfuscated/Shindo%20Life.lua",
